...
// Source: chre_api/include/chre_api/chre/gnss.h @ commit 2f242278
...
static bool chppGnssConvertDataEventToChre(const struct ChppGnssDataEvent *in,
  ...
  if (in->measurements.length != 0) {
    ...
    struct ChppGnssMeasurement *measurementsIn =
        (struct ChppGnssMeasurement *)&((uint8_t *)in)[in->measurements.offset];
