...
// Date: 2020-09-22 19:32:27 UTC
// Source: chre_api/include/chre_api/chre/wwan.h @ commit 2f242278
...
static bool chppWwanConvertCellInfoResultToChre(
  ...
  if (in->cells.length != 0) {
    ...
    struct ChppWwanCellInfo *cellsIn =
        (struct ChppWwanCellInfo *)&((uint8_t *)in)[in->cells.offset];
