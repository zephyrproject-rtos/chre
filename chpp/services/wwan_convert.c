...
// Date: 2020-05-27 18:55:06 UTC
// Source: chre_api/include/chre_api/chre/wwan.h @ commit b7bdcfa4
...
//! chreWwanCellInfoResult as struct ChppWwanCellInfoResult
static size_t chppWwanSizeOfCellInfoResultFromChre(
    const struct chreWwanCellInfoResult *cellInfoResult) {
  size_t encodedSize = sizeof(struct ChppWwanCellInfoResult);
  encodedSize +=
...
bool chppWwanCellInfoResultFromChre(const struct chreWwanCellInfoResult *in,
                                    struct ChppWwanCellInfoResult **out,
                                    size_t *outSize) {
  CHPP_NOT_NULL(out);
  ...
  *out = chppMalloc(payloadSize);
  if (*out != NULL) {
    ...
    chppWwanConvertCellInfoResultFromChre(in, *out, payload, payloadSize,
                                          &vlaOffset);
    *outSize = payloadSize;
    return true;
  }
