...
static void testAndVerifyThreeAxisData(const void *eventData, float extremeLow,
                                       float extremeHigh) {
...
static void testAndVerifyFloatData(const void *eventData, float extremeLow,
                                   float extremeHigh) {
...
void BasicAccelerometerTest::confirmDataIsSane(const void *eventData) {
  ...
  verifyEventThreeAxisData(eventData, -kExtreme, kExtreme);
}
